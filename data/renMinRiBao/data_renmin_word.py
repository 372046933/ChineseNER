...
def originHandle2():
    with open('./renmin2.txt', mode='r', encoding='utf-8') as inp,
        open('./renmin3.txt', mode='w', encoding='utf-8') as outp:
        for line in inp.readlines():
            line = line.split(' ')
            i = 0
            while i < len(line) - 1:
...
def sentence2split():
    with open('./renmin3.txt', 'r') as inp, open('./renmin4.txt', mode='w', encoding='utf-8') as outp:
        texts = inp.read()
...
def data2pkl():
    ...
    tags = set()
    tags.add('')
    input_data = open('renmin4.txt', mode='r', encoding='utf-8')
